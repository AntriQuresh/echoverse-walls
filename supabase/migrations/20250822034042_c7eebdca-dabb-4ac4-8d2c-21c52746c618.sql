...
USING (EXISTS (SELECT 1 FROM public.profiles WHERE id = uploader_id AND user_id = auth.uid()));
...
CREATE POLICY "Users can manage their wallpaper uploads" 
...
CREATE POLICY "Users can manage avatar uploads" 
ON storage.objects FOR ALL 
